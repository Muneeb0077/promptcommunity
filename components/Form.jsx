  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <p className="desc text-left max-w-md">
        {type} and share your own AI-generated prompt with the world.
      </p>
      ...
      <form className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism" onSubmit={handleSubmit}>
        ...
        <label>
          <span className="font-satoshi font-semibold text-base text-gray-700">Tag {` `} <span className="font_normal">(#product, #webdevelopement, #idea)</span></span>
